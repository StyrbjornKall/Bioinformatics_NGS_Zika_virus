...
This notebook presents all the codes used to analyze and visualize the results obtained previously. The files used have been previously moved into the folder results thanks to the script project_script.Rmd .
