...
**This notebook download and unzip the data files from ArrayExpress (https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-8905/samples/?query=zika)**

* **Input** : txt file downloaded from ArrayExpress containing the list of the data to acquire.
* **Output** : folder all_data containing all the unzipped data files
